...
public class SampleContentController {
    ...
    private TableColumn movieID = new TableColumn("Movie ID");
    ...
    public void initialize()
    {
        ...
        ObservableList<String> data = FXCollections.observableArrayList("14 Accompaniment (14A)", "18 Accompaniment (18A)",
                "General (G)", "Parent Guidance (PG)", "Restricted (R)", "Unrated (U)");
